...
> One check if email was in data breaches

[![PyPI version](https://badge.fury.io/py/one-email-leak.svg)](https://pypi.org/project/one-email-leak/)
...
```bash
pip install one-email-leak
```

## Quick Start

```python
from one_email_leak import leak
...
from one_email_leak import batch
